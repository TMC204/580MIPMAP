...
extern int tex_fun(float u, float v, GzColor color, float scaleSizeX, float scaleSizeY, float scaleSizeUm, float scaleSizeVm); /* image texture function */
extern int ptex_fun(float u, float v, GzColor color, int scaleSizeX, int scaleSizeY, int scaleSizeUm, int scaleSizeVm); /* procedural texture function */
extern int ptex_fun_checkboard(float u, float v, GzColor color, int scaleSizeX, int scaleSizeY);
