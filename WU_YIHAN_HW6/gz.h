...
typedef	int(*GzTexture)(float u, float v, GzColor color, float scaleSizeX, float scaleSizeY, float scaleSizeUm, float scaleSizeVm);	/* pointer to texture sampling method */
